    ...
    <div class="cs-container">
        <div class="cs-content">
            <span class="cs-topper">
                ...
                <text class="text1">Широкие возможности использования</text>
                <svg class="cs-chevron" width="49" height="15" viewBox="0 0 49 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.7">
            ...
            <li class="cs-item">
                ...
                <div class="cs-item-text">
                    <ul class="cs-item-text">
                      <li>Скорость разработки ПД</li>
                      <li>Простота изменений</li>
            ...
            <li class="cs-item">
                ...
                <div class="cs-item-text">
                    <ul class="cs-item-text">
                      ...
                      <li>Новейшие технологии ИИ</li>
                      <li>Преимущества на рынке</li>
                    </ul>
                  </div>
            </li>
            <li class="cs-item">
                ...
                <div class="cs-item-text">
                    <ul class="cs-item-text">
                      <li>Расчёт KPI команды</li>
                      <li>Соблюдение сроков</li>
                      <li>Полный контроль задач</li>
                    </ul>
                  </div>
            </li>
            <li class="cs-item">
...
@media only screen and (min-width: 0rem) {
  ...
  #hero-1619 .cs-title {
    /* 39px - 61px */
    font-size: clamp(2.1375rem, 6.4vw, 2.8125rem);
    font-weight: 700;
    line-height: 1.2em;
    text-align: inherit;
    max-width: 100%;
    ...
    position: relative;
    text-shadow:
        1px 1px 0 #000000;   /* Нижний правый */
  }
  #hero-1619 .cs-text {
    /* 16px - 20px */
...
@media only screen and (min-width: 81.25rem) {
  #hero-1619 .cs-item {
    grid-column: span 3;
    border-radius: 30px;
    border: 1px solid #07070717;
    box-shadow: 0px 12px 80px 0px rgba(243,161,160, 0.1);
    /* border: 1px solid #0707072a; */
  }
}
...
.text1 {
    font-size: clamp(0.8125rem, 1.6vw, 0.8rem);
    color: #000000;
    font-weight: 400;
    text-transform: uppercase;
